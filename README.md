...
#### Terminal Verification Output Logs
<details>
<summary><b>Click to expand Monte Carlo simulation speed statistics</b></summary>

Below are the statistical metrics generated by the stochastic acceptance-rejection engine, confirming an error margin below 1% relative to Maxwell-Boltzmann theory:

![Question 2 Terminal Logs](assets/q2_terminal_simulation_logs.png)
